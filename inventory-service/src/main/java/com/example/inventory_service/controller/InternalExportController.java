...
/**
 * Controller xử lý phiếu xuất nội bộ (INTERNAL)
 * Xuất hàng từ kho này sang kho khác
 */
@RestController
@RequestMapping("/api/exports/internal")
@RequiredArgsConstructor
public class InternalExportController {

    private final InternalExportService service;
    ...
    public ResponseEntity<?> create(@RequestBody SupplierExportRequest request) {
        ...
        return ResponseEntity.ok(java.util.Map.of(
                "success", true,
                "message", "Tạo phiếu xuất nội bộ thành công",
                "data", dto));
    }
    ...
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody SupplierExportRequest request) {
        ...
        return ResponseEntity.ok(java.util.Map.of(
                "success", true,
                "message", "Cập nhật phiếu xuất nội bộ thành công",
                "data", dto));
    }
    ...
    public ResponseEntity<?> cancel(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(java.util.Map.of(
                "success", true,
                "message", "Hủy phiếu xuất nội bộ thành công",
                "data", dto));
    }
}
